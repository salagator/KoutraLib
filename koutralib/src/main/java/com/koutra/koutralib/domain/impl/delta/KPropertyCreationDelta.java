...
public class KPropertyCreationDelta extends KDelta {
	
	private static final long serialVersionUID = 552483502483300419L;
	
	private long kObjectId;
	private long kPropertyDefnId;
	private Serializable value;
	
	public KPropertyCreationDelta(IKProperty kProperty) {
	...
	public void apply() throws DeltaApplicationException {
		...
		KoutraPropSysFactory.getKoutraPropSys().createIKProperty(property);
	}
